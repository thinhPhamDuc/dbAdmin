            ...
            <div class="role__content row">
              <div class="col-md-4">
                <div class="role__left">
                  <div class="form-group">
                    ...
                    <input value="<?php echo $role['name']; ?>" type="text" name="name_editRole" class="form-control"
                      id="name_editRole">
                  </div>
              ...
              <div class="col-md-8">
                <div class="role__right">
                  ...
                  ?>
                  <br><br><label class="perChecked"><input id='perChecked' style='margin-right: 5px;' name='inputPers'
                      type='checkbox' checked value=value="<?php echo $row['id']; ?>"><?php echo $module_name; ?>
                  </label>
                  <?php
                      }
                      ?>
                  <label style="display: inline-block; width: 100%; margin-left: 20px">
                    <input style="margin-right: 5px;" name="pers[]" type="checkbox"
                      <?php if (in_array($row['id'], $pers_checked)) echo 'checked'; ?>
